...
when replacing a generated fixture under `draftmyvan/examples/assets/`
...
6. **File path.** Exported GLB basename must equal the basename of
   ...
   `draftmyvan/examples/assets/<basename>`.
...
blender --background --python \
    ...
    --manifest draftmyvan/examples/<module>.json \
    --glb /tmp/<module>.glb
```
...
None of this lands in PR #7. PR #7 only documents the procedure and
...
* `draftmyvan/tools/blender/README.md` — the validator's user manual.
* `draftmyvan/tools/blender/asset_export_checklist.md` — printable
  one-pager of the steps above.
* `draftmyvan/tools/blender/check_asset_ready.py` — one-command
